...
$sql = "SELECT COUNT(id) FROM pm_inbox WHERE userid = '$pid'";
$result = mysql_query($sql);
...
<table width = "800"  border = "0">
	<tr>
		<td> Hi <?php print $username; ?> , please check your income message</td>
	</tr>
	<tr>
...
<table width = "800" border = "0">
	<form name = "form1" method = "post" action = "pm_inbox.php">
		...
		?>
			<?php 
			if ($row[7] == '0') { //show message in bold 
			?>
				<tr>
					<td width = "41" align = "center"><input type = "checkbox" name = "checkbox[]" id = "checkbox[]" value = "<?php echo $row[0]; ?>" /></td>
					<td width = "490"><a href = "pm_view_in.php?in=<?php echo $row[0];?>"<b> <?php echo $row[5]; ?> </b></a></td>
			...
			?>
				<tr>
					<td width = "41" align = "center"><input type = "checkbox" name = "checkbox[]" id = "checkbox[]" value = "<?php echo $row[0]; ?>" /></td>
					<td width = "490"><a href = "pm_view_in.php?in=<?php echo $row[0];?>" <p> <?php echo $row[5]; ?> </p> </a></td>
					<td width = "255"><?php echo $row[4]; ?> </td>
				</tr>
			<?php 
			} 
